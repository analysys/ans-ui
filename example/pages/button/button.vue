...
export default {
  ...
  methods: {
    ...
    info () {
      this.$message.info({ content: 'hello word' + (this.name++), duration: 2, onClose: function () {}, closable: false })
    },
    success () {
      this.$message.success({ content: 'hello word' + (this.name++), duration: 2, onClose: function () {}, closable: false })
    },
    error () {
      this.$message.error({ content: 'hello word' + (this.name++), duration: 2, onClose: function () {}, closable: false })
    },
    loading () {
      this.$message.loading({ content: 'hello word' + (this.name++), duration: 2, onClose: function () {}, closable: false })
    },
    warning () {
      this.$message.warning({ content: 'hello word' + (this.name++), duration: 2, onClose: function () {}, closable: false })
    }
  }
}
</script>
